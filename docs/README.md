...
| twilio.VoiceInsights.CallSummary.from.ip_address | Public IP of Client user | ip |
...
| twilio.VoiceInsights.CallSummary.to.ip_address | Public IP of Client user | ip |
